...
for (i in 1:num_scenarios) {
  ...
  file_path <- here("results", "sim_boot", paste0("scenario_", i, ".RDA"))
  
  # Load the scenario file
  load(file_path)
  
  # Calculate the coverage percentage
  coverage_percentage <- mean(all_boot_percent_estim$coverage == 1) * 100
...
```{r}
load(here("results", "sim_wald", "scenario_18.RDA"))

unique(all_wald_estim$coverage)
```
